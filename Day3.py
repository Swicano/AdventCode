...
test0input1str = 'R8,U5,L5,D3' #6
test0input2str = 'U7,R6,D4,L4'

test1input1str = 'R75,D30,R83,U83,L12,D49,R71,U7,L72' #159
test1input2str = 'U62,R66,U55,R34,D71,R55,D58,R83'

test2input1str = 'R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51' #135
...
# step 1 make a function to generate a set of coordinates of all points a set of instructions passes through
...
intersects = wire_locs(input1) & wire_locs(input2)
